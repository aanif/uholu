...
export default {
    ...
    data(){
            ...
            return{
                ...
                { key: 'customer_id', label: 'Customer ID', sortable: true, class: 'text-center' },
                { key: 'customer_name', label: 'Customer Name', sortable: true, class: 'text-center' },
    ...
    methods:{
          ...
          axios.get('/api/message').then(response=>{
                ...
                $.each(this.items, function(key,value){
                    ...
                    this.items[key].customer_id='1003'+value.id;}
                    else if(this.items[key].user.role=='business'){
                    this.items[key].customer_id='2003'+value.id;}
            ...
            deleteMessage(data){
                var id=data.id;
                axios.delete('/api/delete-message/'+id).then(response=>{
