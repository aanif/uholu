                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href=""><img width="160" height="47" src="http://uholu.com/assets-m/img/brand/uholulogo.png" alt="logo"></a>
                    </td>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              New Pick up Request Has Been Made!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We have received a Pickup Request. <a href="">pick{{$id}}</a>. Kindly go the the admin panel and handle the request.

              {{-- Simply, follow the instructions and we will have your items picked as per your selected pickup option. --}}
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://uholu.com/dashboard/request"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">View Active Requests</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Pickup Address</span><br />
                                {{$name}}  <br />
                                {{$unit}} {{$street}} <br />
                                {{$city}} {{$zip}} <br />
                                Australia <br />
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Date/Time Requested</span><br />
                                {{$created_at}} <br />
                                <br />
                                <span class="header-sm">Order</span> <br />
                                pick{{$id}}
                                <br />
                                <span class="header-sm">Pickup Type</span><br />
                                {{$type}} <br />
                              </td>
                            </tr>
                          </table>
                  ...
                  <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td class="mobile-hide-img">
                            <img width="110" height="92" src="http://icon-library.com/images/icon-safe/icon-safe-1.jpg" alt="item1">
                          </td>
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">key{{$key}}</span> <br />
                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">doc{{$doc}}</span> <br />
            ...
            @endforeach
                  ...
                  <tr>
                    ...
                    <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space">GST</span> <br />
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space">${{$cost*0.9/100}}</span>  <br />
                      <span class="total-space">${{$cost*0.1/100}}</span>  <br />
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">${{$cost/100}}</span>
                    </td>
                  </tr>
                </table>
              </td>
