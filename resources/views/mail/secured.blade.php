    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Your items have been stored securely at Uholu safe. <a href="">pick{{$id}}</a>. Thank you for choosing Uholu.
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://uholu.com/dashboard"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">View Items</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Date/Time Secured</span><br />
                                {{$updated_at}} <br />
                                <br />
