...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
  <tr>
    <td align="left" valign="top" width="100%" style="background:repeat-x url(http://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg) #ffffff;">
      <center>
      {{-- <img src="http://uholu.com/assets-m/img/brand/uholulogo.png" class="force-width-gmail" styl="width:20%"> --}}
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Welcome to Uholu! {{$name}}!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Australia's 1st Safe Custody & Spare Keys Management Service with easy to manage IOS and Android App. <br>
              Simply, download Uholu App from Apple Store or Google Play to manage your Safe Custody and Spare Keys Account 24/7.<br><br>

Also, we are here 24/7 to help you with anything you need.
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="http://uholu.com/dashboard"
