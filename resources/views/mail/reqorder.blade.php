    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Pickup Request Recieved!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We have received your Pickup Request. <a href="">pick{{$id}}</a>. Our team is now in action to send you a Courier Pack along with the instructions.
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://uholu.com/dashboard/activeRequest"
