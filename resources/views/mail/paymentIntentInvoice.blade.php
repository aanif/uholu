    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Following is your receipt of the payment you made on Uholu.
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="{{$link}}"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">View Reciept</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                @endif
                                Stripe ID: {{$stripe_id}}<br />

                                Charge ID: {{$invoice}}<br />
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space">GST:  ${{$cost*0.1/100}}</span>  <br />
                      <span class="total-space">Total Cost:  ${{$cost/100}}</span>  <br />
