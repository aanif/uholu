    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
                New Scan Request Has Been Made!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We have received a Scan Request. <a href="">scan{{$id}}</a>. Kindly go the the admin panel and handle the request.
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://uholu.com/dashboard/scanreq"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">View Scan Requests</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
