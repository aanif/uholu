    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Following is your invoice of the packages you subscribed on Uholu.
          ...
          <tr>
            <td class="button">
              ...
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">View Profile</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Details</span><br />
                                Name: {{$name}}  <br />
                                @if($role=='business')
                                customer ID: 2101{{$id}} <br />
                                @endif
                                @if($role=='customer')
                                customer ID: 1101{{$id}} <br />
                                @endif
                                payment ID: {{$stripe_id}}<br />
                                @if($invoice_doc)
                                Invoice ID (documents): {{$invoice_doc}}<br />
                                @endif
                                @if($invoice_key)
                                Invoice ID (keys): {{$invoice_key}}
                                @endif
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">Keys</span> <br />
                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">Documents</span> <br />
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space">GST:  ${{$cost*0.1}}</span>  <br />
                      <span class="total-space">Total Cost:  ${{$cost}}</span>  <br />
