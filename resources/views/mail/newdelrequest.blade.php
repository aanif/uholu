    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
                New Delivery Request Has Been Made!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We have received a Delivery Request. <a href="">deli{{$id}}</a>. Kindly go the the admin panel and handle the request.

              {{-- We will soon have your items delivered as per your selected delivery option. --}}
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                deli{{$id}}
                                <br />
                                <span class="header-sm">Delivery Type</span><br />
                                {{$type}} <br />
                              </td>
                            </tr>
                          </table>
