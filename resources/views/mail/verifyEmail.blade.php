    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Thank you for creating Uholu account.<br> You will need to verify your email address before accessing your account. Please click the link below to complete your verification.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="{{$link}}"
