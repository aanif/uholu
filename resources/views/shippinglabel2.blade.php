...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: white;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="1000" class="w320">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr >
                              <td class="mini-block" style="width:40%">
                                <span class="header-sm">Date/Time:</span><br />
                                {{$data->updated_at}} <br />
                                <br />
                              ...
                              <td class="mini-block" style="text-align:center">
                                <div style="height:145px"> <img src="https://www.wired.com/wp-content/uploads/blogs/wiredenterprise/wp-content/uploads//2012/12/code.jpg" height="100%"> </div>
                              </td>
                            </tr>
                          </table>
                        </td>
  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: #ffffff;  border-top: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5;">
      <center>
        <table cellpadding="0" cellspacing="0" width="1000" class="w320">
            <tr>
              <td class="item-table">
            ...
            @foreach ($getkey as $key)
                  <tr>
                    <td class="item-col item">
                            ...
                            <span style="color: #4d4d4d; font-weight:bold;">key{{$key->assigned_id}}</span> <br />
            ...
            @foreach ($getdoc as $doc)
                  <tr>
                    <td class="item-col item">
                            ...
                            <span style="color: #4d4d4d; font-weight:bold;">doc{{$doc->assigned_id}}</span> <br />
